...
var population = {
	...
	bindEvent: function() {
		...
		$('.private-add-new').on('click', function() {
			...
			html.push('<p>范围：</p>');
			html.push('<p>');
			html.push('<input type="text" /><span>岁</span><input type="text" /><span>月</span><input type="text" /><span>天</span>');
			html.push('<span class="mxx-zhi">至</span>')
			html.push('<input type="text" /><span>岁</span><input type="text" /><span>月</span><input type="text" /><span>天</span>');
			html.push('</p>');
			html.push('</div>');
			...
			$('.private-button-box').on({
				check: function() {
					...
					html.push('<p>范围：</p>');
					html.push('<p>');
					html.push('<span>0</span><span>岁</span><span>0</span><span>月</span><span>0</span><span>天</span>');
					html.push('<span class="mxx-zhi">至</span>')
					html.push('<span>0</span><span>岁</span><span>0</span><span>月</span><span>0</span><span>天</span>');
					html.push('</p>');
					html.push('</div>');
